...
function SubCategoryFilters({ filterState, setFilterState }) {
...
export default function SubCategoriesPage() {
  return (
    <CrudPage
      ...
      description="Manage sub-categories linked to categories"
      idKey="id"
      ...
      formFields={[
        {
          ...
          type: "select",
          required: true,
          loadOptions: async () => await fetchCategoryOptions(),
          colSpan: 2,
        },
